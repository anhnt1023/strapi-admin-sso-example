...
const HomePage = () => {
  ...
  useEffect(async () => {
    const ssoRoleResponse = await axios.get(`/admin-sso/sso-roles`)
  ...
  const onClickSave = async () => {
    try {
      await axios.put('/admin-sso/sso-roles', {
  ...
  return (
    <CheckPermissions permissions={[{action: 'plugin::admin-sso.read', subject: null}]}>
